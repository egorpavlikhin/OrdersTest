namespace OrdersTest.Migrations
{
    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.UserProcurements",
                c => new
                    {
                        UserId = c.String(nullable: false, maxLength: 128),
                        ProcurementId = c.Long(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.UserProcurements", "ProcurementId", "dbo.Procurements");
            ...
            DropTable("dbo.UserProcurements");
